      ...
      <div className="wf-shell h-screen overflow-hidden text-[var(--foreground)]">
        <section className="grid h-full w-full xl:grid-cols-[220px_1fr]">
          ...
          <main className="min-h-0 min-w-0 overflow-y-auto p-4 sm:p-6">
            ...
            {tourUser && !tourUser.emailVerified && (
              <div className="mb-4 mx-auto max-w-5xl flex items-center justify-between gap-3 rounded-xl border border-amber-500/25 bg-amber-500/[0.07] px-4 py-2.5">
                ...
                <form action="/api/auth/resend-verification" method="post" className="shrink-0">
                  <button type="submit" className="text-xs font-medium text-amber-300 hover:text-amber-200 underline underline-offset-2 transition-colors">
                    Resend
                  </button>
                </form>
              </div>
