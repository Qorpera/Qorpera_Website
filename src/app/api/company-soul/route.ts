...
import { getCompanySoul, setCompanySoul } from "@/lib/company-soul-store";
import { CompanySoulBody } from "@/lib/schemas";
...
export async function GET() {
  ...
  const companySoul = await getCompanySoul(userId);
  return NextResponse.json({ companySoul });
}
