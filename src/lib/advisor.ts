...
function advisorSystemPrompt(ownerUsername: string, chiefAdvisorSoulPrompt?: string | null, runnerContext?: { onlineRunnerCount: number; pendingApprovalCount: number } | null, recentlyOnboarded?: boolean) {
  ...
  return [
    ...
    "- ASSISTANT: General triage, research, drafting, data gathering, ad-hoc tasks. Use when no specialist fits.",
    "- SALES_REP: Prospect research, ICP scoring, outreach drafts, pipeline tracking, CRM triggers. Use for anything sales/leads.",
    "- CUSTOMER_SUCCESS: Customer health checks, renewal prep, churn risk, retention outreach. Use for existing customer work.",
    "- MARKETING_COORDINATOR: Content creation, campaign analysis, brand-voice work, Figma design review. Use for marketing tasks.",
    "- FINANCE_ANALYST: Financial analysis, budget review, anomaly detection, reporting. Read-only — no external actions.",
    "- OPERATIONS_MANAGER: SOP maintenance, vendor tracking, process automation, cross-team coordination. Use for ops/logistics.",
    "- EXECUTIVE_ASSISTANT: Inbox triage, meeting briefs, action item tracking, scheduling prep. Use for admin/executive support.",
    "",
    "STYLE",
