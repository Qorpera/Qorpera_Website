...
const SETUP_PRICE_ENV: Partial<Record<HireAgentKind, string>> = {
  ...
  PROJECT_MANAGER: "STRIPE_PRICE_PROJECT_MANAGER",
...
const RECURRING_PRICE_ENV: Record<HireAgentKind, Record<HireSchedule, string>> = {
  ...
  PROJECT_MANAGER: {
    DAILY: "STRIPE_SUB_PRICE_PROJECT_MANAGER_DAILY",
    WEEKLY: "STRIPE_SUB_PRICE_PROJECT_MANAGER_WEEKLY",
    MONTHLY: "STRIPE_SUB_PRICE_PROJECT_MANAGER_MONTHLY",
  },
  SALES_REP: {
